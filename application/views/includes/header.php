  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Mulia</b></span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="<?php echo base_url(); ?>tagihan">
              <i class="fa fa-credit-card"></i> <span>Tagihan</span></i>
            </a>
          </li>
          ...
          ?>
            ...
            <li>
              <a href="<?php echo base_url(); ?>vendor_">
                <i class="fa fa-group"></i> <span>Vendor</span></i>
              </a>
            </li>
            <li>
